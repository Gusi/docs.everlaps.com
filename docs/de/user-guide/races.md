...
- **Import**: 
	...
	- **from internet**: Loads the list directly from internet web site, as long as the web [race password](../race-formats/qualify-finals/index.html#campos-de-formato) has been introduced.
...
- **Excluded**: The penalised driver will be placed last in all race results. The excluded drivers will no longer be included in the automatic generation of new series. See [penalties and corrections](../common-tasks/punishments-corrections/index.html) for more information.
...
- **Best heat**: Allows a driver to be penalised with the loss of *best heat*. See [penalties and corrections](../common-tasks/punishments-corrections/index.html) for more information.
